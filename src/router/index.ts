  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        name: "PcDataFilling",
        component: () =>
          import("../views/pc/dashboard/subViews/dataFilling/index.vue"),
        meta: {
          title: "数据填报",
          icon: "home-outlined",
          affix: true,
      ...
      },
      {
        ...
        component: () =>
          import("../views/pc/dashboard/subViews/trackStatusFilling/index.vue"),
        meta: {
          title: "在轨信息填报",
          icon: "home-outlined",
          affix: true,
      ...
      },
      {
        ...
        name: "PcIssueWork",
        component: () =>
          import("../views/pc/dashboard/subViews/issueWork/index.vue"),
        meta: {
          title: "工作下发",
          icon: "home-outlined",
          affix: true,
      ...
      },
      {
        ...
        name: "PcDataOverview",
        component: () =>
          import("../views/pc/dashboard/subViews/dataOverview/index.vue"),
        meta: {
          title: "计划填报总览",
          icon: "home-outlined",
          affix: true,
      ...
      },
      {
        ...
        component: () =>
          import(
            "../views/pc/dashboard/subViews/trackStatusOverview/index.vue"
          ),
        meta: {
          title: "在轨信息填报总览",
          icon: "home-outlined",
      ...
      },
      {
        ...
        component: () =>
          import("../views/pc/dashboard/subViews/workIssueOverview/index.vue"),
        meta: {
          title: "工作下发总览",
          icon: "home-outlined",
          affix: true,
      ...
      },
      {
        ...
        component: () =>
          import("../views/pc/dashboard/subViews/fillingProcess/index.vue"),
        meta: {
          title: "填报流程",
          icon: "home-outlined",
          affix: true,
